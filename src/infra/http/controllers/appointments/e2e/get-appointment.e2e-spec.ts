...
describe("Get Appointment (E2E)", () => {
  ...
  it("[GET] /appointment/:appointmentId", async () => {
    ...
    expect(response.body.appointment.id).toEqual(appointment.id.toString());
    expect(response.body.appointment.name).toEqual(appointment.name);
  });
});
